...
export function MultiLangButton() {
    ...
    {<button
     ...
     title="Subtitles/closed captions (c)">
        <svg class="ytp-subtitles-button-icon" height="100%" version="1.1" viewBox="0 0 36 36" width="100%" fill-opacity="1">
        ...
        {createPortal(<SrtLoadMenuItem />, document.getElementById('srtFileInput'))}
    </>
}
...
function SrtLoadMenuItem() {
    return <>
        <div class="ytp-menuitem-icon">CC</div>
        <div class="ytp-menuitem-label">Load .srt</div>
        <div class="ytp-menuitem-content"><div><input type="file" /></div></div>
    </>
}